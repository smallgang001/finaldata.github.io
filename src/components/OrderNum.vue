...
<script>
import TanTuo from "../components/OrderTantuo.vue";
    ...
    aSSS(x = 1) {
      ...
      this.axios.get(Apiallpage).then((e) => {
        ...
        if (e.data.success) {
          ...
          this.newpage = Math.ceil(this.pages.length / 5);
          this.page = this.newpage;
          this.unpage = x;
          this.onpage = x;
          this.newproducts = this.pages.slice((x - 1) * 5, x * 5);
          this.xxx = x;
        }
      });
    },
